...
struct StorageSize: CustomStringConvertible, Comparable, LargeIntCodable {
    ...
    var longDescription: String {
        describe("bytes", kilos: "kilobytes", megas: "megabytes", gigas: "gigabytes", teras: "terabytes")
    }
...
extension UInt64 {
    ...
    var megs: StorageSize { StorageSize(bytes: Int64(Int64(self) * StorageSize.k64 * StorageSize.k64)) }
}
