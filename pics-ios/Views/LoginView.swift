...
class LoginHandler: NSObject, ObservableObject, AWSCognitoIdentityPasswordAuthentication {
  ...
  var passwordAuthenticationCompletion:
...
extension LoginHandler: AWSCognitoIdentityNewPasswordRequired {
  func getNewPasswordDetails(
    _ newPasswordRequiredInput: AWSCognitoIdentityNewPasswordRequiredInput,
    newPasswordRequiredCompletionSource: AWSTaskCompletionSource<
  ...
  func save(password: String) {
    let newPassDetails = AWSCognitoIdentityNewPasswordRequiredDetails(
      proposedPassword: password, userAttributes: [:])
    ...
    if handler.isComplete {
      ...
      ZStack {
        ...
        .toolbar {
          ...
          Alert(
            title: Text("Authentication error"), message: Text("Failed to log in."),
